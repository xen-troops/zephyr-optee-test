...
TEEC_Result ta_crypt_cmd_allocate_operation(struct ADBG_Case *c, TEEC_Session *s,
...
TEEC_Result ta_crypt_cmd_allocate_transient_object(struct ADBG_Case *c,
						   TEEC_Session *s,
...
TEEC_Result ta_crypt_cmd_populate_transient_object(struct ADBG_Case *c,
						   TEEC_Session *s,
						   TEE_ObjectHandle o,
...
TEE_Result ta_crypt_cmd_set_operation_key(struct ADBG_Case *c, TEEC_Session *s,
					  TEE_OperationHandle oph,
...
TEEC_Result ta_crypt_cmd_free_transient_object(struct ADBG_Case *c, TEEC_Session *s,
					       TEE_ObjectHandle o)
{
	TEEC_Result res = TEEC_ERROR_GENERIC;
	TEEC_Operation op = TEEC_OPERATION_INITIALIZER;
...
TEEC_Result ta_crypt_cmd_derive_key(struct ADBG_Case *c, TEEC_Session *s,
...
TEEC_Result ta_crypt_cmd_get_object_buffer_attribute(struct ADBG_Case *c,
						     TEEC_Session *s,
						     TEE_ObjectHandle o,
						     uint32_t attr_id,
...
TEEC_Result ta_crypt_cmd_free_operation(struct ADBG_Case *c, TEEC_Session *s,
					TEE_OperationHandle oph)
{
	TEEC_Result res = TEEC_ERROR_GENERIC;
	TEEC_Operation op = TEEC_OPERATION_INITIALIZER;
...
bool ta_crypt_cmd_is_algo_supported(struct ADBG_Case *c, TEEC_Session *s,
