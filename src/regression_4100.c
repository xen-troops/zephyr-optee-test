...
void *regression_4100_init(void)
{
...
void regression_4100_deinit(void *param)
{
	(void)param;
...
ZTEST(regression_4100, test_4101)
{
	ADBG_STRUCT_DECLARE("Test TEE Internal API Arithmetical API - Bigint init");
        test_4101(&c);
        ADBG_Assert(&c);
}
...
ZTEST(regression_4100, test_4102)
{
	ADBG_STRUCT_DECLARE("Test TEE Internal API Arithmetical API - Octet string");
	test_4102(&c);
	ADBG_Assert(&c);
}
...
ZTEST(regression_4100, test_4103)
{
	ADBG_STRUCT_DECLARE("Test TEE Internal API Arithmetical API - S32");
	test_4103(&c);
	ADBG_Assert(&c);
}
...
ZTEST(regression_4100, test_4104)
{
	ADBG_STRUCT_DECLARE("Test TEE Internal API Arithmetical API - Compare");
	test_4104(&c);
	ADBG_Assert(&c);
}
...
ZTEST(regression_4100, test_4105)
{
	ADBG_STRUCT_DECLARE("Test TEE Internal API Arithmetical API - Add, Sub");
	test_4105(&c);
	ADBG_Assert(&c);
}
...
ZTEST(regression_4100, test_4106)
{
	ADBG_STRUCT_DECLARE("Test TEE Internal API Arithmetical API - Neg");
	test_4106(&c);
	ADBG_Assert(&c);
}
...
ZTEST(regression_4100, test_4107)
{
	ADBG_STRUCT_DECLARE("Test TEE Internal API Arithmetical API - Mul");
	test_4107(&c);
	ADBG_Assert(&c);
}
...
ZTEST(regression_4100, test_4108)
{
	ADBG_STRUCT_DECLARE("Test TEE Internal API Arithmetical API - Div");
	test_4108(&c);
	ADBG_Assert(&c);
}
...
ZTEST(regression_4100, test_4109)
{
	ADBG_STRUCT_DECLARE("Test TEE Internal API Arithmetical API - Mod");
	test_4109(&c);
	ADBG_Assert(&c);
}
...
ZTEST(regression_4100, test_4110)
{
	ADBG_STRUCT_DECLARE("Test TEE Internal API Arithmetical API - Mod arith");
	test_4110(&c);
	ADBG_Assert(&c);
}
...
ZTEST(regression_4100, test_4111)
{
	ADBG_STRUCT_DECLARE("Test TEE Internal API Arithmetical API - Invmod");
	test_4111(&c);
	ADBG_Assert(&c);
}
...
ZTEST(regression_4100, test_4112)
{
	ADBG_STRUCT_DECLARE("Test TEE Internal API Arithmetical API - Is prime");
	test_4112(&c);
	ADBG_Assert(&c);
}
...
ZTEST(regression_4100, test_4113)
{
	ADBG_STRUCT_DECLARE("Test TEE Internal API Arithmetical API - shift right");
...
ZTEST(regression_4100, test_4114)
{
	ADBG_STRUCT_DECLARE("Test TEE Internal API Arithmetical API - GCD");

	test_4114(&c);
	ADBG_Assert(&c);
}

ZTEST_SUITE(regression_4100, NULL, regression_4100_init, NULL, NULL,
	    regression_4100_deinit);
