 ...
 */
TEEC_Result ta_crypt_cmd_allocate_operation(struct ADBG_Case *c,
			   TEEC_Session *s,
...
TEE_Result ta_crypt_cmd_set_operation_key(struct ADBG_Case *c,
			 TEEC_Session *s,
			 TEE_OperationHandle oph,
			 TEE_ObjectHandle key);

TEEC_Result ta_crypt_cmd_free_transient_object(struct ADBG_Case *c,
			      TEEC_Session *s,
			      TEE_ObjectHandle o);

TEEC_Result ta_crypt_cmd_derive_key(struct ADBG_Case *c,
					   TEEC_Session *s,
					   TEE_OperationHandle oph,
					   TEE_ObjectHandle o,
...
TEEC_Result ta_crypt_cmd_free_operation(struct ADBG_Case *c,
					       TEEC_Session *s,
					       TEE_OperationHandle oph);
